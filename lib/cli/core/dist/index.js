...
const checkGlobalUpdate = () => __awaiter(void 0, void 0, void 0, function* () {
    const currentVersion = pkg.version;
    const npmName = pkg.name;
    const latestVersion = yield utils.http.getNpmSemverVersion(currentVersion, npmName);
    if (latestVersion && semver__default["default"].gt(latestVersion, currentVersion)) {
        utils.log.warn('checkGlobalUpdate', colors__default["default"].yellow(`请手动更新 ${npmName}, 当前版本：${currentVersion}, 最新版本；${latestVersion}`));
    }
});
