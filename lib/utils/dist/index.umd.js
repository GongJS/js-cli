(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('path'), require('fs'), require('child_process'), require('util'), require('events'), require('stream'), require('buffer'), require('os'), require('assert'), require('http'), require('https'), require('url'), require('zlib')) :
	typeof define === 'function' && define.amd ? define(['exports', 'path', 'fs', 'child_process', 'util', 'events', 'stream', 'buffer', 'os', 'assert', 'http', 'https', 'url', 'zlib'], factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["@js/utils"] = {}, global.path, global.fs, global.cp, global.require$$0$1, global.require$$0, global.require$$0$2, global.require$$0$3, global.require$$0$4, global.require$$0$5, global.require$$1, global.require$$2, global.require$$0$6, global.require$$8));
})(this, (function (exports, path, fs, cp, require$$0$1, require$$0, require$$0$2, require$$0$3, require$$0$4, require$$0$5, require$$1, require$$2, require$$0$6, require$$8) { 'use strict';
  ...
  src[t.BUILD]}?`);
	...
	const readFile = (path, options = {}) => {
	    if (fs__default["default"].existsSync(path)) {
	        const buffer = fs__default["default"].readFileSync(path);
	        if (buffer) {
	            if (options.toJson) {
