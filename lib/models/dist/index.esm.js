import { isObject, http, log, readFile, writeFile, spinnerStart } from '@js-cli/utils';
    ...
    getCorrectVersion() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!releaseVersion) {
                ...
                const incType = (yield inquirer.prompt({
                    type: 'list',
                    name: 'incType',
    ...
    checkGitServer() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!gitServer || this.refreshServer) {
                gitServer = (yield inquirer.prompt({
                    type: 'list',
                    name: 'gitServer',
