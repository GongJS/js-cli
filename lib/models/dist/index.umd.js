(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('path'), require('child_process'), require('util'), require('events'), require('stream'), require('buffer'), require('os'), require('assert'), require('http'), require('https'), require('url'), require('zlib'), require('fs'), require('constants')) :
    typeof define === 'function' && define.amd ? define(['exports', 'path', 'child_process', 'util', 'events', 'stream', 'buffer', 'os', 'assert', 'http', 'https', 'url', 'zlib', 'fs', 'constants'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["@js/models"] = {}, global.require$$1$1, null, global.require$$0$1, global.require$$0, global.require$$0$2, global.require$$0$3, global.require$$0$4, global.require$$0$5, global.require$$1, global.require$$2, global.require$$0$6, global.require$$8, global.require$$0$7, global.require$$0$8));
})(this, (function (exports, require$$1$1, cp, require$$0$1, require$$0, require$$0$2, require$$0$3, require$$0$4, require$$0$5, require$$1, require$$2, require$$0$6, require$$8, require$$0$7, require$$0$8) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    util$7.inherits(TrackerBase$2, EventEmitter);
  ...
  src[t.BUILD]}?`);
    ...
    ***************************************************************************** */
    ...
    const fs$k = require$$0__default$7["default"];
    const {promisify: promisify$1} = require$$0__default$1["default"];
    const pLocate = pLocate_1;

    const fsStat = promisify$1(fs$k.stat);
    const fsLStat = promisify$1(fs$k.lstat);
    ...
    locatePath.exports = async (paths, options) => {
    	...
    	return pLocate(paths, async path_ => {
    		try {
    			const stat = await statFn(path$e.resolve(options.cwd, path_));
    ...
    locatePath.exports.sync = (paths, options) => {
    	...
    	const statFn = options.allowSymlinks ? fs$k.statSync : fs$k.lstatSync;

    	for (const path_ of paths) {
    		try {
    			const stat = statFn(path$e.resolve(options.cwd, path_));
    ...
    const fs$j = require$$0__default$7["default"];
    ...
    const pkgDir = async cwd => {
    	...
    	return filePath && path$d.dirname(filePath);
    };
    ...
    var fs$h = require$$0__default$7["default"];
    ...
    if (!fs$h[gracefulQueue]) {
      ...
      if (/\bgfs4\b/i.test(process.env.NODE_DEBUG || '')) {
        process.on('exit', function() {
          ...
          require$$0__default$5["default"].equal(fs$h[gracefulQueue].length, 0);
        });
      }
    }
